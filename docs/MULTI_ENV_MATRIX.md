...
| 域名 | sm-notification-center.dev.sm.example.com | sm-notification-center.staging.sm.example.com | sm-notification-center.sm.example.com |
| TLS | 关闭 | sm-staging-tls | sm-tls |
| 数据库 | sm_notification_center（dev 实例） | sm_notification_center（staging 实例） | sm_notification_center（primary） |
